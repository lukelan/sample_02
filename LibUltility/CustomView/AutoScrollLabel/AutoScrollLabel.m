...
- (void)commonInit
{
    ...
    self.labels = [[labelSet.allObjects copy] autorelease];
...
-(void)setAlignmentForText:(UITextAlignment)myTextAlignment
{
    self.textAlignment = myTextAlignment;
    self.mainLabel.textAlignment = self.textAlignment;
}
@end
