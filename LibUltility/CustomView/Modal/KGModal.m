...
static NSString* KGModalGradientViewTapped = @"KGModalGradientViewTapped";

@interface KGModalGradientView : UIView
@end

@interface KGModalContainerView : UIView
@property (strong, nonatomic) CALayer *styleLayer;
...
@interface KGModalViewController : CustomViewController
