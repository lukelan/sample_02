...
@property (nonatomic, strong) VNGSegmentedThumb *thumb;
...
@implementation VNGSegmentedControl
...
- (VNGSegmentedThumb *)thumb {
    
    if(_thumb == nil)
        _thumb = [[VNGSegmentedThumb alloc] initWithFrame:CGRectZero];
