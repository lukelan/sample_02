...
@property (nonatomic, readonly) VNGSegmentedControl *segmentedControl;
...
@implementation VNGSegmentedThumb
...
- (VNGSegmentedControl *)segmentedControl {
    return (VNGSegmentedControl*)self.superview;
}
