...
#import "VNGSegmentedThumb.h"
#import <AvailabilityMacros.h>

@protocol VNGSegmentedControlDelegate;

@interface VNGSegmentedControl : UIControl
...
@property (nonatomic, strong, readonly) VNGSegmentedThumb *thumb;
...
- (VNGSegmentedControl*)initWithSectionTitles:(NSArray*)titlesArray;
...
- (void)segmentedControl:(VNGSegmentedControl*)segmentedControl didSelectIndex:(NSUInteger)index;
