...
//  This view takes a HMSegmentedControl and put it in UIScrollView in the same frame to enable scrolling.
//  Initial and changes of selectedSegmentIndex auto scrolls the scrollView.
//  Example usage:
/*  
...
- (void)setDefaultValues {
    ...
    self.scrollView.backgroundColor = self.segmentedControl.backgroundColor;
...
//        [self adjustViewToSize:CGSizeMake(700, self.frame.size.height)];
...
//    return self.segmentedControl.sectionTitles.count * self.minimumSegmentWidth;
    int width = [[self.segmentedControl.pointList lastObject] intValue] - 20;
    return width;
}
